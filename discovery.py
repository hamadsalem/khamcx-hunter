...
class DexscreenerClient:
    ...
    async def get_latest_profiles(self):
        try:
            ...
            log.warning("get_latest_profiles error: " + str(e))
            return []
    ...
    async def get_latest_boosts(self):
        try:
            ...
            log.warning("get_latest_boosts error: " + str(e))
            return []
    ...
    async def get_pairs(self, token_addr):
        ...
        try:
            ...
            log.warning("get_pairs error: " + str(e))
            return []
...
async def batch_run():
    ...
    log.info("=" * 60)
    log.info("KHAMCX Hunter Bot V2 - Started")
    ...
    async with aiohttp.ClientSession(
        headers={"User-Agent": "KHAMCXHunter/2.0"}
    ) as session:
